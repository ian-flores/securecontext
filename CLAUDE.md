...
An R package for memory, knowledge persistence, RAG retrieval, and
context window management for R LLM agents.

## Architecture

- S3 classes for value objects: document, retriever, context_builder,
  embedder
